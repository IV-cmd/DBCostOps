...
class AnomalyDetector:
    ...
    def get_historical_costs(self, node_name: str, days: int = 30) -> list:
        ...
        try:
            ...
            response = self.prom.query_range(
                cost_query,
                start=(datetime.now() - timedelta(days=days)).isoformat(),
                end=datetime.now().isoformat()
            )
            return self.prom.extract_range_values(response)
    ...
    def get_current_metrics(self, database_type: str, instance_type: str, node_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Query CPU, memory, storage, connections
            ...
            storage_gb = self.prom.extract_value(self.prom.query(storage_query))
